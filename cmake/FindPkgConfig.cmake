...
macro(_pkgconfig_invoke _pkglist _prefix _varname _regexp)
  ...
  if(_pkgconfig_failed)
    ...
    if(NOT ${_regexp} STREQUAL "")
      string(REGEX REPLACE "${_regexp}" " " _pkgconfig_invoke_result
                           "${_pkgconfig_invoke_result}")
    endif()
...
# Internal version of pkg_get_variable; expects PKG_CONFIG_PATH to already be
# set
...
macro(_pkgconfig_invoke_dyn _pkglist _prefix _varname cleanup_regexp)
  _pkgconfig_invoke("${_pkglist}" ${_prefix} ${_varname} "${cleanup_regexp}"
                    ${ARGN})
  _pkgconfig_invoke("${_pkglist}" ${_prefix} STATIC_${_varname}
...
# Usage: - _pkgconfig_add_extra_path(_extra_paths VAR) -
...
# result of _pkg_find_libs is automatically propagated
...
macro(
  ...
  if(PKG_CONFIG_EXECUTABLE)
    ...
    if(_pkg_check_modules_failed)
      ...
      _pkgconfig_invoke_dyn("${_pkg_check_modules_packages}" "${_prefix}"
                            INCLUDE_DIRS "(^| )(-I|-isystem ?)" --cflags-only-I)
      _pkgconfig_invoke_dyn("${_pkg_check_modules_packages}" "${_prefix}"
                            CFLAGS "" --cflags)
      _pkgconfig_invoke_dyn("${_pkg_check_modules_packages}" "${_prefix}"
