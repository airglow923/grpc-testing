...
function(protobuf_generate)
  ...
  foreach(_proto ${protobuf_generate_PROTOS})
    ...
    add_custom_command(
      ...
      COMMAND
        protobuf::protoc ARGS --${protobuf_generate_LANGUAGE}_out
        ${_dll_export_decl}${protobuf_generate_PROTOC_OUT_DIR} ${_plugin}
...
function(PROTOBUF_GENERATE_CPP SRCS HDRS)
  ...
  if(protobuf_generate_cpp_DESCRIPTORS)
    set(${protobuf_generate_cpp_DESCRIPTORS}
        "${${protobuf_generate_cpp_DESCRIPTORS}}"
        PARENT_SCOPE)
  endif()
endfunction()
...
# Backwards compatibility Define camel case versions of input variables
foreach(
  UPPER
  PROTOBUF_SRC_ROOT_FOLDER
  PROTOBUF_IMPORT_DIRS
...
function(_protobuf_find_libraries name filename)
  ...
  elseif(${name}_LIBRARY)
    ...
    find_library(
      ...
      NAMES ${filename} NAMES_PER_DIR
      PATHS ${Protobuf_SRC_ROOT_FOLDER}/vsprojects/${_PROTOBUF_ARCH_DIR}Release)
    mark_as_advanced(${name}_LIBRARY_RELEASE)

    find_library(
      ${name}_LIBRARY_DEBUG
      NAMES ${filename}d ${filename} NAMES_PER_DIR
...
# By default have PROTOBUF_GENERATE_CPP macro pass -I to protoc for each
# directory where a proto file is referenced.
if(NOT DEFINED PROTOBUF_GENERATE_CPP_APPEND_PATH)
  set(PROTOBUF_GENERATE_CPP_APPEND_PATH TRUE)
endif()

# Google's provided vcproj files generate libraries with a "lib" prefix on
# Windows
if(MSVC)
...
if(Protobuf_INCLUDE_DIR)
  ...
  if(_PROTOBUF_COMMON_H_CONTENTS MATCHES
  ...
  if(Protobuf_PROTOC_EXECUTABLE)
    ...
    if(NOT "${_PROTOBUF_PROTOC_EXECUTABLE_VERSION}" VERSION_EQUAL
      ...
      message(
        WARNING
          "Protobuf compiler version ${_PROTOBUF_PROTOC_EXECUTABLE_VERSION}"
    ...
    if(NOT TARGET protobuf::libprotobuf)
      ...
      if(MSVC AND NOT Protobuf_USE_STATIC_LIBS)
        set_property(
          TARGET protobuf::libprotobuf
          APPEND
          PROPERTY INTERFACE_COMPILE_DEFINITIONS "PROTOBUF_USE_DLLS")
      endif()
  ...
  if(Protobuf_LITE_LIBRARY)
    if(NOT TARGET protobuf::libprotobuf-lite)
      ...
      if(EXISTS "${Protobuf_LITE_LIBRARY_DEBUG}")
        ...
        set_target_properties(
          protobuf::libprotobuf-lite
          PROPERTIES IMPORTED_LOCATION_DEBUG "${Protobuf_LITE_LIBRARY_DEBUG}")
      endif()
      if(MSVC AND NOT Protobuf_USE_STATIC_LIBS)
        set_property(
          TARGET protobuf::libprotobuf-lite
  ...
  if(Protobuf_PROTOC_LIBRARY)
    if(NOT TARGET protobuf::libprotoc)
      ...
      set_target_properties(
        protobuf::libprotoc PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                       "${Protobuf_INCLUDE_DIR}")
      ...
      if(EXISTS "${Protobuf_PROTOC_LIBRARY_RELEASE}")
        set_property(
          ...
          PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
        set_target_properties(
          protobuf::libprotoc PROPERTIES IMPORTED_LOCATION_RELEASE
      ...
      if(EXISTS "${Protobuf_PROTOC_LIBRARY_DEBUG}")
        set_property(
          ...
          PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
        set_target_properties(
          protobuf::libprotoc PROPERTIES IMPORTED_LOCATION_DEBUG
                                         "${Protobuf_PROTOC_LIBRARY_DEBUG}")
      endif()
      if(Protobuf_VERSION VERSION_GREATER_EQUAL "3.6")
        set_property(
...
# Backwards compatibility Define upper case versions of output variables
foreach(
  Camel
  Protobuf_SRC_ROOT_FOLDER
  Protobuf_IMPORT_DIRS
