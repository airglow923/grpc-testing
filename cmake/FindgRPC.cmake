...
function(_grpc_fix_grpc_cpp_plugin_target)
  ...
  # executable for the imported target (at least they do not in v1.19.1), so we
...
if(_gRPC_grpc_LIBRARY)
  if(NOT TARGET gRPC::grpc)
    ...
    if(EXISTS "${_gRPC_grpc_LIBRARY_DEBUG}")
      ...
      set_target_properties(gRPC::grpc PROPERTIES IMPORTED_LOCATION_DEBUG
                                                  "${_gRPC_grpc_LIBRARY_DEBUG}")
    endif()
    set_property(
      TARGET gRPC::grpc
      APPEND
      PROPERTY INTERFACE_LINK_LIBRARIES protobuf::libprotobuf Threads::Threads)
  endif()
endif()
  ...
  if(NOT TARGET gRPC::grpc++)
    ...
    set_property(
      ...
      PROPERTY INTERFACE_LINK_LIBRARIES gRPC::grpc protobuf::libprotobuf
               Threads::Threads)
    # gRPC++ requires C++14. It does not yet define the compile features, so we
    # define the feature ourselves.
    set_property(
      TARGET gRPC::grpc++
      APPEND
