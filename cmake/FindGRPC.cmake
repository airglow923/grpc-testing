...
#
# GRPC::grpc - GRPC library GRPC::grpc++ - GRPC C++ library
# GRPC::grpc++_reflection - GRPC C++ reflection library GRPC::grpc_cpp_plugin -
# C++ generator plugin for Protocol Buffers
#
...
#
# SRCS - variable to define with autogenerated source files HDRS - variable to
# define with autogenerated header files DEST - directory where the source files
# will be created ARGN - .proto files
#
function(GRPC_GENERATE_CPP SRCS HDRS DEST)
  if(NOT ARGN)
    message(
      SEND_ERROR "Error: GRPC_GENERATE_CPP() called without any proto files")
    return()
  endif()
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND
        ${PROTOBUF_PROTOC_EXECUTABLE} ARGS --grpc_out ${DEST}
        ${_protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN}
        ${ABS_FIL}
...
# By default have GRPC_GENERATE_CPP macro pass -I to protoc for each directory
# where a proto file is referenced.
...
find_package_handle_standard_args(
  GRPC REQUIRED_VARS GRPC_LIBRARY GRPC_INCLUDE_DIR
...
if(GRPC_FOUND
  ...
  set_target_properties(
    GRPC::grpc
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
